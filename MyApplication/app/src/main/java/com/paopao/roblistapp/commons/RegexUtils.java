package com.paopao.roblistapp.commons;
...
public class RegexUtils {
     ...
     * @return {@link #VERIFY_SUCCESS}, {@link #VERIFY_TYPE_ERROR}, {@link #VERIFY_LENGTH_ERROR}
     */
    public static int verifyPhoneNumber(String PhoneNumber) {
        Preconditions.checkNonNull(PhoneNumber, "verifyPassword: PhoneNumber is null!");
